...
class TestSenseBlockDeaf_02_Effect(_TestSenseBlock):
    ...
    def test_01_deafenC0(self):
        ...
        self.c1.assert_received_ooc('You have deafened {}.'.format(self.c0_cname), over=True)
    ...
    def test_02_deafhearsnothing(self):
        ...
        self.c0.sic('Hello?')
        self.c0.assert_received_ic('(Your ears are ringing)', folder=self.c0_cname,
        ...
        self.c0.assert_received_ic('(Your ears are ringing)', folder=self.c1_cname,
                                   anim='happy', over=True)
        ...
        self.c0.assert_received_ic('(Your ears are ringing)', folder=self.c0_cname,
                                   anim='happy', over=True)
        self.c1.assert_received_ic('I cant hear you :(', folder=self.c0_cname,
                                   anim='happy', over=True)
        self.c2.assert_no_ic()
        self.c3.assert_no_ic()

        self.c2.sic('I still hear myself.')
        self.c2.assert_received_ic('I still hear myself.', folder=self.c2_cname,
                                   anim='happy', over=True)
    ...
    def test_03_deafchangesarea(self):
        ...
        self.c2.sic('Oi m8.')
        self.c0.assert_received_ic('(Your ears are ringing)', folder=self.c2_cname,
                                   anim='happy', over=True)
        ...
        self.c0.assert_received_ic('(Your ears are ringing)', folder=self.c0_cname,
                                   anim='sad', over=True)
        self.c2.assert_received_ic('Cant hear you.', folder=self.c0_cname,
                                   anim='sad', over=True)
        self.c1.assert_no_ic()
        self.c3.assert_no_ic()
    ...
    def test_04_deafhearspecialmessages(self):
        ...
        self.c0.assert_received_ic('*attempts to listen.', folder=self.c0_cname, over=True)
        self.c2.assert_received_ic('*attempts to listen.', folder=self.c0_cname, over=True)

...
class TestScream_01_Scream(_TestOOC):
    ...
    def test_02_nonstaffscream(self):
        ...
        self.c0.assert_ic('Hi', cid=0, pos=self.c0.pos, showname='', over=True)
    ...
    def test_03_staffscream(self):
        ...
        self.c1.assert_ic('Ha', cid=1, pos=self.c1.pos, showname='', over=True)
        self.c2.assert_ooc('(X) {} [{}] screamed "Ha" ({}).'.format(self.c1_dname, 1, 0), over=True)
        self.c2.assert_no_ic() # C2 is not in scream range
        self.c3.assert_no_packets() # C3 is not in scream range
        ...
        self.c1.assert_ooc('(X) {} [{}] screamed "He" ({}).'.format(self.c2_dname, 2, 4), over=True)

...
class TestSenseBlockGag_02_Effect(_TestSenseBlock):
    ...
    def test_01_gagC0(self):
        ...
        self.c1.assert_received_ooc('You have gagged {}.'.format(self.c0_charname), over=True)
    ...
    def test_02_gaggedsaysnothing(self):
        ...
        self.c0.sic('Hello?')
        self.c0.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='happy', over=True)
        self.c1.assert_received_ooc('{} tried to say "{}" but is currently gagged.'
                                    .format(self.c0_charname, 'Hello?'), ooc_over=True)
        self.c1.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='happy', over=True)
        self.c2.assert_no_ic()
        self.c3.assert_no_ic()

        self.c1.sic('I cant understand you.')
        self.c0.assert_received_ic('I cant understand you.', folder=self.c1_charname,
                                   anim='happy', over=True)
        self.c1.assert_received_ic('I cant understand you.', folder=self.c1_charname,
                                   anim='happy', over=True)
        self.c2.assert_no_ic()
        self.c3.assert_no_ic()
        ...
        self.c0.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='mood', over=True)
        self.c1.assert_received_ooc('{} tried to say "{}" but is currently gagged.'
                                    .format(self.c0_charname, 'Mood'), ooc_over=True)
        self.c1.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='mood', over=True)
        self.c2.assert_no_ic()
        self.c3.assert_no_ic()
        ...
        self.c2.assert_received_ic('I can still talk myself.', folder=self.c2_charname,
                                   anim='happy', over=True)
    ...
    def test_03_gaggedchangesarea(self):
        ...
        self.c2.assert_received_ic('Oi m8.', folder=self.c2_charname,
                                   anim='happy', over=True)
        self.c3.assert_received_ic('Oi m8.', folder=self.c2_charname,
                                   anim='happy', over=True)
        self.c1.assert_no_ic()
        ...
        self.c2.assert_received_ooc('{} tried to say "{}" but is currently gagged.'
                                    .format(self.c0_charname, 'Im gagged.'), ooc_over=True)
        self.c2.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='sad', over=True)
        self.c3.assert_received_ic('(Gagged noises)', folder=self.c0_charname,
                                   anim='sad', over=True)
        self.c3.assert_no_ic()
    ...
    def test_04_gaggedsaysspecialmessages(self):
        ...
        self.c0.assert_received_ic('*attempts to talk.', folder=self.c0_charname, over=True)
        self.c2.assert_received_ic('*attempts to talk.', folder=self.c0_charname, over=True)
        self.c3.assert_received_ic('*attempts to talk.', folder=self.c0_charname, over=True)
        ...
        self.c3.assert_received_ic('((is confused about C0', folder=self.c2_charname, over=True)
        ...
        self.c3.assert_received_ic('[y r u liek dis', folder=self.c0_charname, over=True)

...
class TestLights_01_Basic(_TestLights):
    def test_01_wrongarguments(self):
        ...
        self.c0.ooc('/lights')
        self.c0.assert_received_ooc('You must specify either on or off.', over=True)
        ...
        self.c0.assert_received_ooc('Expected on or off.', over=True)
        self.c1.assert_no_packets()
        self.c2.assert_no_packets()
        self.c3.assert_no_packets()
        self.assert_lights(1, 0)
        ...
        self.c0.assert_received_ooc("Unable to turn lights off or on: This area's background is "
                                    "locked.", over=True)
        self.c1.assert_no_packets()
        self.c2.assert_no_packets()
        self.c3.assert_no_packets()
        ...
        self.c1.assert_received_ooc("Unable to turn lights off or on: This area's background is "
                                    "locked.", over=True)
        ...
        self.c3.assert_received_ooc('This area has no lights to turn off or on.', over=True)
        self.c0.assert_no_packets()
        self.c1.assert_no_packets()
        self.c2.assert_no_packets()
        self.assert_lights(1, 0)
    ...
    def test_02_normielightsoffon(self):
        ...
        self.c3.ooc('/lights off')
        self.c0.assert_received_packet('BN', self.blackout_background)
        self.c0.assert_received_ooc('The lights were turned off.', over=True)
        self.c1.assert_no_packets()
        self.c2.assert_received_packet('BN', self.blackout_background)
        self.c2.assert_received_ooc('{} turned the lights off.'.format(self.c3_cname), over=True)
        self.c3.assert_received_packet('BN', self.blackout_background)
        self.c3.assert_received_ooc('You turned the lights off.', over=True)
        self.assert_lights(1, {self.area4})

        self.c3.ooc('/lights on')
        self.c0.assert_received_packet('BN', self.area4.background)
        self.c0.assert_received_ooc('The lights were turned on.', over=True)
        self.c1.assert_no_packets()
        self.c2.assert_received_packet('BN', self.area4.background)
        self.c2.assert_received_ooc('{} turned the lights on.'.format(self.c3_cname), over=True)
        self.c3.assert_received_packet('BN', self.area4.background)
        self.c3.assert_received_ooc('You turned the lights on.', over=True)
        self.assert_lights(1, 0)
    ...
    def test_03_stafflightsoffon(self):
        ...
        self.c3.assert_received_packet('BN', self.blackout_background)
        self.c3.assert_received_ooc('The lights were turned off.', over=True)
        self.assert_lights(1, {self.area4})
    ...
    def test_04_cannotdoubleofforon(self):
        ...
        self.c3.ooc('/lights on')
        self.c3.assert_received_ooc('The lights are already turned on.', over=True)
        self.c0.assert_no_packets()
        self.c1.assert_no_packets()
        self.c2.assert_no_packets()
        self.assert_lights(1, 0)
        ...
        self.c3.ooc('/lights off')
        self.c3.assert_received_ooc('The lights are already turned off.', over=True)
        self.c0.assert_no_packets()
        self.c1.assert_no_packets()
        self.c2.assert_no_packets()
        self.assert_lights(1, {self.area4})
    ...
    def test_05_differentplayersswitching(self):
        ...
        self.c0.assert_received_packet('BN', self.area4.background)
        self.c0.assert_received_ooc('You turned the lights on.', over=True)
        self.c1.assert_no_packets()
        self.c2.assert_received_packet('BN', self.area4.background)
        self.c2.assert_received_ooc('{} turned the lights on.'.format(self.c0_cname), over=True)
        self.c3.assert_received_packet('BN', self.area4.background)
        self.c3.assert_received_ooc('The lights were turned on.', over=True)
        self.assert_lights(1, 0)
    ...
    def test_06_lightswitchcrusade(self):
        ...
        self.c3.move_area(5)
        self.c3.ooc('/lights on')
        self.c3.assert_received_packet('BN', self.area5.background)
        self.c3.assert_received_ooc('You turned the lights on.', over=True)
        ...
        self.c3.ooc('/lights on')
        self.c3.assert_received_packet('BN', self.area7.background)
        self.c3.assert_received_ooc('You turned the lights on.', over=True)
        self.assert_lights(1, {self.area6})

        self.c3.move_area(6)
        self.c3.ooc('/lights on')
        self.c3.assert_received_packet('BN', self.area6.background)
        self.c3.assert_received_ooc('You turned the lights on.', over=True)
        self.assert_lights(1, 0)
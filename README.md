...
Coding assistance/automation in coding has always been a thing in the forms of programming languages, debuggers, autocomplete, etc. so an LLM that can automate tedious, repetitive and uncreative tasks such as boilerplate code is something I find acceptable. It is also impossible to tell the difference between human-made and ai-generated boilerplate code if it is competently made. However you should also never let AI drive your creative deicisions in code and you should at least be the architect and understand what you're actually using these for.
